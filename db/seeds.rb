...
User.create(name: "tata", email:"@", image: "", isRecruiter:false)
User.create(name: "tonton", email:"@", image: "", isRecruiter: false)
User.create(name: "titi", email:"@", image: "", isRecruiter: false)
